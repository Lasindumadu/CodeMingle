...
(1, 1, 'What is Java?', 'A programming language', 'A coffee brand', 'An island', 'A framework', 'A programming language', 1);

INSERT IGNORE INTO questions (question_id, quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, question_order) VALUES
(2, 1, 'Java is platform independent. True or False?', 'True', 'False', 'Sometimes', 'Never', 'True', 2);

INSERT IGNORE INTO questions (question_id, quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, question_order) VALUES
(3, 2, 'What does Spring Boot provide?', 'Auto-configuration', 'Embedded servers', 'Production-ready features', 'All of the above', 'All of the above', 1);
